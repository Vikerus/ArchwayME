...
//cookie*
	$host = "archway.io"; // Server host name or IP
//Encryption and Decryption should be used to protect COOKIES
//cookie*
	$port = 2; // Port rcon is listening on
//Encryption and Decryption should be used to protect COOKIES
//cookie*
	$password = "hashmyballs66"; // rcon.password setting set in server.properties
...
if ($rcon->connect())
{
  $rcon->send_command("cp give $sender $amount from@archway.io");
